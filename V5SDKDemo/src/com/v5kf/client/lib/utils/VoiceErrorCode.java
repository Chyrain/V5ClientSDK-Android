...
public class VoiceErrorCode {
    ...
    public static String getErrorInfo(Context vContext, int vType) throws NotFoundException
    {
        ...
        case SUCCESS:
            return "success";
        case E_NOSDCARD:
            return vContext.getResources().getString(UIUtil.getIdByName(vContext, "string", "v5_error_no_sdcard"));
        case E_STATE_RECODING:
            return vContext.getResources().getString(UIUtil.getIdByName(vContext, "string", "v5_error_state_record"));  
        case E_UNKOWN:
        default:
            return vContext.getResources().getString(UIUtil.getIdByName(vContext, "string", "v5_error_unknown"));           
