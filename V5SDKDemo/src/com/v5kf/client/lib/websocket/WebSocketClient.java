...
//                	Logger.d(TAG, "[connect] new Thread.run() -> timer");
                	...
                	mConnectionTask = new TimerTask(){  
                    	public void run() {
//                    		Logger.d(TAG, "[ConnectionTask] TimerTask.run()");
                	...
                	try {
                		...
                		ex.printStackTrace();
                		Logger.w(TAG, "Already in connection...");
                		return;
                	}
//                	Logger.d(TAG, "[connect] new Thread.run()");
...
//                    Logger.d(TAG, "[connect] mConnectionTimer reset before");
                    if (mConnectionTimer != null) {
                		mConnectionTimer.cancel();
                		mConnectionTimer = null;
                    	if (mConnectionTask != null) {
...
//                		Logger.d(TAG, "[connect] mConnectionTimer timeout already reset");
                		mConnected = false;
                		return;
                	}
                    mConnected = true;
//                    Logger.d(TAG, "[connect] mConnectionTimer reset after");
                    mListener.onConnect();
