...
//		setBackgroundDrawable(null);
		...
		//设置弹窗的布局界面
		setContentView(LayoutInflater.from(mContext).inflate(UIUtil.getIdByName(context, "layout", "v5_list_popup"), null));
	 ...
	 */
	private void initUI(){
		mListView = (ListView) getContentView().findViewById(UIUtil.getIdByName(mContext, "id", "title_list"));
