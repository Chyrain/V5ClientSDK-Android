...
public class NewsListAdapter extends BaseAdapter {
    ...
    public View getDivider(ViewGroup parent) {
    	View div = mInflater.inflate(UIUtil.getIdByName(mContext, "layout", "v5_item_divider"), parent, false);
    	return div;
    }
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
        	if (getItemViewType(position) == VIEW_TYPE_HEAD) {
        		convertView = mInflater.inflate(UIUtil.getIdByName(mContext, "layout", "v5_item_chat_news_head"), parent, false);
    			holder = new ViewHolder(convertView);
    		} else {
    			convertView = mInflater.inflate(UIUtil.getIdByName(mContext, "layout", "v5_item_chat_news_item"), parent, false);
				holder = new ViewHolder(convertView);
    		}
    	...
    	ImageLoader imgLoader = new ImageLoader(mContext, true, UIUtil.getIdByName(mContext, "drawable", "v5_empty_img"));
    ...
    class ViewHolder {
    	...
    	public ViewHolder(View itemView) {
			mTitleTv = (TextView) itemView.findViewById(UIUtil.getIdByName(mContext, "id", "id_news_title_text"));
			mPicIv = (ImageView) itemView.findViewById(UIUtil.getIdByName(mContext, "id", "ic_news_img_iv"));
		}
