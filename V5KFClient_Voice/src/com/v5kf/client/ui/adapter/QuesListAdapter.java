...
//	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
        	convertView = mInflater.inflate(UIUtil.getIdByName(mActivity, "layout", "v5_item_ques_text"), parent, false) ;
        ...
        holder.mMsg.setBackgroundResource(UIUtil.getIdByName(mActivity, "color", "v5_ques_bg_normal"));
        if (mStates.get(position) != null && mStates.get(position)) {
        	holder.mMsg.setBackgroundResource(UIUtil.getIdByName(mActivity, "color", "v5_ques_bg_select"));
        }
    ...
    class QuesViewHolder {
        ...
        public QuesViewHolder(View itemView) {
            mMsg = (TextView) itemView.findViewById(UIUtil.getIdByName(mActivity, "id", "id_ques_text"));
        }
    }
