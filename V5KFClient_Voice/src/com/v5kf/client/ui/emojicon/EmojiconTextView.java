...
public class EmojiconTextView extends TextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs == null) {
            ...
            TypedArray a = getContext().obtainStyledAttributes(attrs, UIUtil.getStyleableArray(getContext(), "Emojicon")); // R.styleable.Emojicon
            mEmojiconSize = (int) a.getDimension(UIUtil.getStyleable(getContext(), "Emojicon_emojiconSize"), getTextSize());
            a.recycle();
        }
        setText(getText());
    }
