...
//    private AnimatorSet mPlayByOutAnimatorSet;
    ...
    public EmoticonsIndicatorView(Context context, AttributeSet attrs) {
        ...
        bmpSelect= BitmapFactory.decodeResource(getResources(), UIUtil.getIdByName(getContext(), "drawable", "v5_indicator_point_select1"));
        bmpNomal= BitmapFactory.decodeResource(getResources(), UIUtil.getIdByName(getContext(), "drawable", "v5_indicator_point_nomal"));
    }
