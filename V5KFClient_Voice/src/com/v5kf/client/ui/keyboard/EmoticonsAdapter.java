...
public class EmoticonsAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(UIUtil.getIdByName(mContext, "layout", "v5_item_emoticon"), null);
            convertView.setLayoutParams(new AbsListView.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, mItemHeight));
            viewHolder.iv_face = (ImageView) convertView.findViewById(UIUtil.getIdByName(mContext, "id", "item_iv_face"));
            viewHolder.rl_content = (RelativeLayout) convertView.findViewById(UIUtil.getIdByName(mContext, "id", "rl_content"));
            viewHolder.rl_parent = (RelativeLayout) convertView.findViewById(UIUtil.getIdByName(mContext, "id", "rl_parent"));
        ...
        if (emoticonBean != null) {
            viewHolder.rl_parent.setBackgroundResource(UIUtil.getIdByName(mContext, "drawable", "v5_iv_face"));
