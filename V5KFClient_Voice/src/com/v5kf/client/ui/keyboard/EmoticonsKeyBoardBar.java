...
//    private EditText et_chat;
    ...
    public EmoticonsKeyBoardBar(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(UIUtil.getIdByName(getContext(), "layout", "v5_view_keyboardbar"), this);
        initView();
    }

    private void initView() {
        mEmoticonsPageView = (EmoticonsPageView) findViewById(UIUtil.getIdByName(getContext(), "id", "view_epv"));
        mEmoticonsIndicatorView = (EmoticonsIndicatorView) findViewById(UIUtil.getIdByName(getContext(), "id", "view_eiv"));
        mEmoticonsToolBarView = (EmoticonsToolBarView) findViewById(UIUtil.getIdByName(getContext(), "id", "view_etv"));

        rl_input = (RelativeLayout) findViewById(UIUtil.getIdByName(getContext(), "id", "rl_input"));
        ly_foot_func = (LinearLayout) findViewById(UIUtil.getIdByName(getContext(), "id", "ly_foot_func"));
        btn_face = (ImageView) findViewById(UIUtil.getIdByName(getContext(), "id", "btn_face"));
        btn_voice_or_text = (ImageView) findViewById(UIUtil.getIdByName(getContext(), "id", "btn_voice_or_text"));
        btn_voice = (Button) findViewById(UIUtil.getIdByName(getContext(), "id", "btn_voice"));
        btn_multimedia = (ImageView) findViewById(UIUtil.getIdByName(getContext(), "id", "btn_multimedia"));
        btn_send = (Button) findViewById(UIUtil.getIdByName(getContext(), "id", "btn_send"));
        et_chat = (EmojiconEditText) findViewById(UIUtil.getIdByName(getContext(), "id", "et_chat"));
...
*/
    ...
    public void setEditableState(boolean b) {
        if (b) {
            ...
            et_chat.setFocusableInTouchMode(true);
            et_chat.requestFocus();
            rl_input.setBackgroundResource(UIUtil.getIdByName(getContext(), "drawable", "v5_edit_input_border_bg_active"));
        } else {
            et_chat.setFocusable(false);
            et_chat.setFocusableInTouchMode(false);
            rl_input.setBackgroundResource(UIUtil.getIdByName(getContext(), "drawable", "v5_edit_input_border_bg_normal"));
        }
    }
...
//	public EditText getEt_chat() {//////
        ...
        switch (event.getKeyCode()) {
            case KeyEvent.KEYCODE_BACK:
                if (ly_foot_func != null && ly_foot_func.isShown()) {
                    hideAutoView();
                    btn_face.setImageResource(UIUtil.getIdByName(getContext(), "drawable", "v5_icon_face_normal"));
                    return true;
                } else {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == UIUtil.getIdByName(getContext(), "id", "btn_face")) {
        	// 确保输入框显示
        	rl_input.setVisibility(VISIBLE);
            btn_voice.setVisibility(GONE);
            btn_voice_or_text.setImageResource(UIUtil.getIdByName(getContext(), "drawable", "v5_btn_voice_or_text_bg"));
            ...
            switch (mKeyboardState){
                ...
                case KEYBOARD_STATE_BOTH:
                    ...
                    btn_face.setImageResource(UIUtil.getIdByName(getContext(), "drawable", "v5_icon_face_pop"));
                    showAutoView();
                    break;
        ...
        else if (id == UIUtil.getIdByName(getContext(), "id", "btn_send")) {
            if(mKeyBoardBarViewListener != null){
                mKeyBoardBarViewListener.OnSendBtnClick(et_chat.getText().toString());
            }
        }
        else if (id == UIUtil.getIdByName(getContext(), "id", "btn_multimedia")) {
            switch (mKeyboardState){
                case KEYBOARD_STATE_NONE:
                case KEYBOARD_STATE_BOTH:
        ...
        else if (id == UIUtil.getIdByName(getContext(), "id", "btn_voice_or_text")) {
            if(rl_input.isShown()) {
                hideAutoView();
                rl_input.setVisibility(GONE);
                btn_voice.setVisibility(VISIBLE);
				btn_voice_or_text.setImageResource(UIUtil.getIdByName(getContext(), "drawable", "v5_btn_softkeyboard_bg"));
            } else {
                rl_input.setVisibility(VISIBLE);
                btn_voice.setVisibility(GONE);
                setEditableState(true);
        ...
        else if (id == UIUtil.getIdByName(getContext(), "id", "btn_voice")) {
            if(mKeyBoardBarViewListener != null){
