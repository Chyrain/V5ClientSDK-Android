...
public class BubbleImageView extends ImageView {
	...
	private void initView(AttributeSet attrs) {
		if (attrs != null) {
			TypedArray a = getContext().obtainStyledAttributes(attrs, UIUtil.getStyleableArray(getContext(), "BubbleImageView"));
			mAngle = (int) a.getDimension(UIUtil.getStyleable(getContext(), "BubbleImageView_bubble_angle"), mAngle);
			mArrowHeight = (int) a.getDimension(UIUtil.getStyleable(getContext(), "BubbleImageView_bubble_arrowHeight"), mArrowHeight);
			mArrowOffset = (int) a.getDimension(UIUtil.getStyleable(getContext(), "BubbleImageView_bubble_arrowOffset"), mArrowOffset);
			mArrowTop = (int) a.getDimension(UIUtil.getStyleable(getContext(), "BubbleImageView_bubble_arrowTop"), mArrowTop);
			mArrowWidth = (int) a.getDimension(UIUtil.getStyleable(getContext(), "BubbleImageView_bubble_arrowWidth"), mAngle);
			mArrowLocation = a.getInt(UIUtil.getStyleable(getContext(), "BubbleImageView_bubble_arrowLocation"), mArrowLocation);
			a.recycle();
		}
	}
