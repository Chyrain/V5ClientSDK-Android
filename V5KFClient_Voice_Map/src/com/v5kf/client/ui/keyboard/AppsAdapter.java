...
public class AppsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(UIUtil.getIdByName(mContext, "layout", "v5_item_app"), parent, false);
            viewHolder.iv_icon = (ImageView) convertView.findViewById(UIUtil.getIdByName(mContext, "id", "iv_icon"));
            viewHolder.tv_name = (TextView) convertView.findViewById(UIUtil.getIdByName(mContext, "id", "tv_name"));
