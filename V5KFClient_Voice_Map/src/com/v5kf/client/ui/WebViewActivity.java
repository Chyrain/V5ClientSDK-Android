...
public class WebViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(UIUtil.getIdByName(this, "layout", "v5_activity_web_view"));
	...
	private void findView() {
		...
		mWebView = (WebView) findViewById(UIUtil.getIdByName(this, "id", "id_web_view"));
		mLoadingLl = (LinearLayout) findViewById(UIUtil.getIdByName(this, "id", "layout_container_empty"));
	}
	...
	private void initTitleBar() {
		if (mTitleId == 0) {
			mTitleId = UIUtil.getIdByName(this, "string", "v5_chat_title");
		}
		Button mRightBtn = ((Button)findViewById(UIUtil.getIdByName(this, "id", "header_right_btn")));
		mRightBtn.setBackgroundResource(UIUtil.getIdByName(this, "drawable", "v5_action_bar_more"));
    ...
    private void initPopupMenu(){
    	...
    	mTitlePopup.addAction(new ActionItem(this, UIUtil.getIdByName(this, "string", "v5_refresh"), UIUtil.getIdByName(this, "drawable", "v5_popmenu_refresh")));
    	mTitlePopup.addAction(new ActionItem(this, UIUtil.getIdByName(this, "string", "v5_open_by_browser"), UIUtil.getIdByName(this, "drawable", "v5_popmenu_browser")));
